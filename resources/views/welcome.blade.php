...
<head>
  ...
  <title>Clean info Blog - Start First Blog</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="{{url('/')}}">Start First Blog</a>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>Clean Info Blog</h1>
            <span class="subheading">A Clean Info Blog by Start First Blog</span>
          </div>
        </div>
      </div>
    </div>
...
<script type="text/JavaScript" src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/js/toastr.min.js"></script>
  ...
  <!-- <script type="{{ asset('https://unpkg.com/sweetalert/dist/sweetalert.min.js')}}"></script> -->
